export function patchConfigReady() {
	const config = {
		weaponTypes: {
...
export function patchConfigSetup() {
	...
	if (game.modules.get("wfrp4e-middenheim")?.active) {
		const config = {
			symptoms: {
				homicidalRaging: "Убийственная ярость",
			},
			symptomDescriptions: {
				homicidalRaging:
